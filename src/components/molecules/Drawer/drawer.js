const openMenuDrawer = document.getElementById('open-menu-drawer')
...
const Default = {
	...
	onShow: () => {
		openMenuDrawer?.classList.add('active-menu')
		closeMenuDrawer?.classList.add('active-menu')
	},
	onHide: () => {
		openMenuDrawer?.classList.remove('active-menu')
		closeMenuDrawer?.classList.remove('active-menu')
	},
	onToggle: () => {}
}
...
export const getDrawerInstance = (id, instances) => {
