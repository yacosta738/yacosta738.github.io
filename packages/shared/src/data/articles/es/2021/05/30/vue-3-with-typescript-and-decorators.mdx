...
Ahora simplemente vaya a [http://localhost:8080/](http://localhost:8080/). Puede encontrar el código fuente de ejemplo [aquí](https://github.com/yacosta738/vue-typescript-decorators).
