...
description: Combinando mis pasiones por la astronomía y la programación, estoy creando un sitio web para hacer la cuenta regresiva de los días hasta el año nuevo, con una simulación del movimiento de la Tierra.
date: 2020-12-27
...
![Ejemplo](/src/assets/images/images/example.webp "Demo de Ejemplo")
...
<html lang="en">
  ...
  <body>
    ...
    <div id="warning">
      <p>
        parece que la tierra se ha salido de su órbita...
        <button id="reload">RE-ORBITAR</button>
      </p>
    </div>
    <!-- partial -->
