...
date: 2020-12-06
cover: src/assets/images/portada-proxy.webp
...
![Proxy schema](/src/assets/images/proxy-schema.webp 'Configure proxy global on linux')

A continuación veremos como configurar un proxy en algunas de las distros GNU/Linux

![Proxy global](/src/assets/images/proxy-global.webp)
...
![pacman.conf.webp](/src/assets/images/pacman.conf.webp)
...
- Debian: [redsocks](https://packages.debian.org/search?searchon=names&keywords=redsocks)
- Gentoo (zugaina overlay): [redsocks](https://gpo.zugaina.org/net-proxy/redsocks)
...
Para compilar redsock necesitamos clonar su repositorio en GitHub [https://github.com/darkk/redsocks](https://github.com/darkk/redsocks) y seguir las instrucciones en el **README.md**. Es necesario que en nuestro sistema esté instalado **[libevent-2.0.x](https://libevent.org/)**, al igual que los compiladores `gcc` y `clang`. La compilación es tan fácil como ejecutar `make` en el directorio raíz del proyecto.
...
### Paquetes de proxychains para las distintas distribuciones linux
...
- Fedora: [proxychains-ng](https://github.com/rofl0r/proxychains-ng)
- Ubuntu: [proxychains](https://packages.ubuntu.com/search?searchon=names&keywords=proxychains)
...
![More data](/src/assets/images/more-data.webp)
...
![Windscribe Help](/src/assets/images/windscribe-help.webp)
