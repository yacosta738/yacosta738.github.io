...
In [](https://docs.spring.io/spring-boot/reference/io/caching.html)[boot-features-caching](https://docs.spring.io/spring-boot/reference/io/caching.html) you have the different Cache implementations that Spring Boot supports, among which is [EhCache](https://www.ehcache.org/), with which you can define different types of backend for the data, as well as specify data validity times and many more options.
