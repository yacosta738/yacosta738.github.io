...
description: Combining my passions for astronomy and programming, I'm creating a website to countdown the days until the new year, with a simulation of the earth's movement.
date: 2020-12-27
lastModified: 2025-09-23T07:42:00
author: en/yuniel-acosta-perez
cover: src/assets/images/portada.webp
tags:
  - en/javascript
  - en/typescript
  - en/html
  ...
  <body>
    ...
    <div id="warning">
      <p>
        ...
        <button id="reload">RE-ORBIT</button>
      </p>
    </div>
    <!-- partial -->
...
All the code can be downloaded from GitHub at the following link: [countdown repo](https://github.com/yacosta738/countdown-to-new-year)
