...
1. [Single Responsibility Principle](/en/2023/03/01/s-the-single-responsibility-principle) (SRP)
...
2. [Open-Closed Principle (OCP)](/en/2023/03/01/o-the-open-closed-principle-extending-behaviors-without-modifying-code/)
...
3. [Liskov Substitution Principle (LSP)](/en/2023/03/08/l-the-liskov-substitution-principle/)
...
4. [Interface Segregation Principle (ISP)](/en/2023/03/17/i-the-interface-segregation-principle/)
...
5. [Dependency Inversion Principle (DIP)](/en/2023/03/18/d-the-dependency-inversion-principle/)
