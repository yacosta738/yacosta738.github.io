...
cover: src/assets/images/java-developers-check-out-these-github-repositories-.png
...
This project contains style guides for major languages used by Google, such as the [Java Style Guide](https://google.github.io/styleguide/javaguide.html).
