...
cover: src/assets/images/solid-principles-explained.png
...
1. [Principio de responsabilidad única](https://yunielacosta.com/es/blog/2023/03/01/s-the-single-responsibility-principle/) (SRP)
...
2. [Principio Abierto-Cerrado](https://yunielacosta.com/es/blog/2023/03/01/o-the-open-closed-principle-extending-behaviors-without-modifying-code/) (OCP)
...
3. [Principio de sustitución de Liskov](https://yunielacosta.com/es/blog/2023/03/08/l-the-liskov-substitution-principle/) (LSP)
...
4. [Principio de Segregación de Interfaces](https://yunielacosta.com/es/blog/2023/03/17/i-the-interface-segregation-principle/) (ISP)
...
5. [Principio de Inversión de Dependencias](https://yunielacosta.com/es/blog/2023/03/18/d-the-dependency-inversion-principle/) (DIP)
