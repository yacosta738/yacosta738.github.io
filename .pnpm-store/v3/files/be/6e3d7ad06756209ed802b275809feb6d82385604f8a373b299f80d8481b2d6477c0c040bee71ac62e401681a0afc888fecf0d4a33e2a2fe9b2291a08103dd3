...
var Decoration = function (_Record) {
  ...
  createClass(Decoration, [{
    ...
    value: function fromJSON(object) {
      ...
      if (object.mark && !type) {
        index(false, 'As of slate@0.47 the `decoration.mark` property has been changed to `decoration.type` and `decoration.data` directly.');
...
var Text = function (_Record) {
  ...
  createClass(Text, [{
    ...
    value: function fromJSON(object) {
      ...
      index$1(object.leaves == null, 'As of slate@0.46, the `leaves` property of text nodes has been removed! Each individual leaf should be created as a text node instead.');
      ...
      if (immutable.List.isList(elements) || Array.isArray(elements)) {
        ...
        elements.forEach(function (el) {
          if (el && el.object === 'text' && el.leaves && Array.isArray(el.leaves)) {
            index(false, 'As of slate@0.46, the `leaves` property of Text nodes has been removed. Instead, each text node contains a string of text and a unique set of marks and leaves are unnecessary.');
...
var debug = browser$1('slate:operation:apply');
...
var debug$1 = browser$1('slate:operation:invert');
...
var debug$2 = browser$1('slate:editor');
...
var Leaf$1 = function (_Record) {
  ...
  createClass(Leaf, [{
    ...
    value: function create() {
      ...
      index(false, 'As of slate@0.47 the `Leaf` model is deprecated.');
...
memoize$2(NodeInterface.prototype, ['getFirstText', 'getKeysToPathsTable', 'getLastText', 'getText', 'normalize', 'validate']);
...
var ElementInterface = function () {
  ...
  createClass(ElementInterface, [{
    ...
    value: function filterDescendants() {
      var predicate = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : identity$2;
    ...
    value: function getFurthest(path) {
      var predicate = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : identity$2;
    ...
    value: function mapDescendants() {
      ...
      nodes.forEach(function (node, index$$1) {
        ...
        ret = predicate(ret, index$$1, _this3.nodes);
        if (ret === node) return;
    ...
    value: function getNextTextAndPath(path) {
      index(false, 'As of slate@0.47, the `getNextTextAndPath` method has been renamed to `getNextTextEntry`.');
    ...
    value: function getNextDeepMatchingNodeAndPath(path) {
      ...
      index(false, 'As of slate@0.47, the `getNextDeepMatchingNodeAndPath` method is deprecated.');
    ...
    value: function getPreviousTextAndPath(path) {
      index(false, 'As of slate@0.47, the `getPreviousTextAndPath` method has been renamed to `getPreviousTextEntry`.');
    ...
    value: function findFirstDescendantAndPath(iterator, pathToThisNode) {
      index(false, 'As of slate@0.47, the `findFirstDescendantAndPath` method is deprecated.');
    ...
    value: function getPreviousMatchingNodeAndPath(path) {
      ...
      index(false, 'As of slate@0.47, the `getPreviousMatchingNodeAndPath` method is deprecated.');
    ...
    value: function getPreviousDeepMatchingNodeAndPath(path) {
      ...
      index(false, 'As of slate@0.47, the `getPreviousDeepMatchingNodeAndPath` method is deprecated.');
    ...
    value: function findLastDescendantAndPath(iterator, pathToThisNode) {
      index(false, 'As of slate@0.47, the `findLastDescendantAndPath` method is deprecated.');
    ...
    value: function findDescendantAndPath(iterator) {
      ...
      index(false, 'As of slate@0.47, the `findDescendantAndPath` method is deprecated.');
    ...
    value: function forEachDescendantWithPath(iterator) {
      ...
      index(false, 'As of slate@0.47, the `forEachDescendantWithPath` method is deprecated.');
    ...
    value: function getNextMatchingNodeAndPath(path) {
      ...
      index(false, 'As of slate@0.47, the `getNextMatchingNodeAndPath` method is deprecated.');
    ...
    value: function getSelectionIndexes(range) {
      ...
      index(false, 'As of slate@0.47, the `getSelectionIndexes` method is deprecated.');
    ...
    value: function getTextsBetweenPositionsAsArray(startPath, endPath) {
      index(false, 'As of slate@0.47, the `getTextsBetweenPositionsAsArray` method is deprecated.');
    ...
    value: function getOrderedMarksBetweenPositions(startPath, startOffset, endPath, endOffset) {
      index(false, 'As of slate@0.47, the `getOrderedMarksBetweenPositions` method is deprecated.');
    ...
    value: function getTextsBetweenPathPositionsAsArray(startPath, endPath) {
      index(false, 'As of slate@0.47, the `getTextsBetweenPathPositionsAsArray` method is deprecated.');
    ...
    value: function getFurthestAncestor(path) {
      index(false, 'As of slate@0.47, the `getFurthestAncestor` method has been renamed to `getFurthestChild`.');
    ...
    value: function getLeafBlocksAtRangeAsArray(range) {
      index(false, 'As of slate@0.47, the `getLeafBlocksAtRangeAsArray` method is deprecated.');
    ...
    value: function getLeafBlocksBetweenPathPositionsAsArray(startPath, endPath) {
      index(false, 'As of slate@0.47, the `getLeafBlocksBetweenPathPositionsAsArray` method is deprecated.');
    ...
    value: function getBlocksAsArray() {
      index(false, 'As of slate@0.47, the `getBlocksAsArray` method is deprecated.');
    ...
    value: function getBlocksByTypeAsArray(type) {
      index(false, 'As of slate@0.47, the `getBlocksByTypeAsArray` method is deprecated.');
    ...
    value: function getFurthestOnlyChildAncestor(path) {
      index(false, 'As of slate@0.47, the `getFurthestOnlyChildAncestor` method is deprecated.');
    ...
    value: function getInlinesAsArray() {
      index(false, 'As of slate@0.47, the `getInlinesAsArray` method is deprecated.');
    ...
    value: function getInlinesByTypeAsArray(type) {
      index(false, 'As of slate@0.47, the `getInlinesByTypeAsArray` method is deprecated.');
    ...
    value: function getLeafInlinesAtRangeAsArray(range) {
      ...
      index(false, 'As of slate@0.47, the `getLeafInlinesAtRangeAsArray` method is deprecated.');
    ...
    value: function getOrderedMarks() {
      index(false, 'As of slate@0.47, the `getOrderedMarks` method has been folded into `getMarks`, which will now return an ordered set.');
      return this.getMarks();
    }
  }, {
    key: 'getOrderedMarksAtRange',
    value: function getOrderedMarksAtRange(range) {
      index(false, 'As of slate@0.47, the `getOrderedMarksAtRange` method has been folded into `getMarksAtRange`, which will now return an ordered set.');
      return this.getMarksAtRange(range);
    }
  }, {
    key: 'getOrderedMarksByType',
    value: function getOrderedMarksByType(type) {
      index(false, 'As of slate@0.47, the `getOrderedMarksByType` method has been folded into `getMarksByType`, which will now return an ordered set.');
      return this.getMarksByType(type);
    }
  }, {
    key: 'getMarksByTypeAsArray',
    value: function getMarksByTypeAsArray(type) {
      index(false, 'As of slate@0.47, the `getMarksByTypeAsArray` method is deprecated.');
    ...
    value: function getMarksAsArray() {
      ...
      index(false, 'As of slate@0.47, the `getMarksAsArray` method is deprecated.');
    ...
    value: function getRootInlinesAtRangeAsArray(range) {
      ...
      index(false, 'As of slate@0.47, the `getRootInlinesAtRangeAsArray` method is deprecated.');
    ...
    value: function getTextsAsArray() {
      index(false, 'As of slate@0.47, the `getTextsAsArray` method is deprecated.');
    ...
    value: function getTextsAtRangeAsArray(range) {
      index(false, 'As of slate@0.47, the `getTextsAtRangeAsArray` method is deprecated.');
    ...
    value: function getMarksAtPosition(path, offset) {
      index(false, 'As of slate@0.47, the `getMarksAtPosition` method is deprecated.');
    ...
    value: function getNodesAtRange(range) {
      index(false, 'As of slate@0.47, the `getNodesAtRange` method has been renamed to `getDescendantsAtRange`.');
    ...
    value: function isNodeInRange(path, range) {
      index(false, 'As of slate@0.47, the `isNodeInRange` method has been renamed to `isInRange`.');
