...
let $33065e702bd15fb9$var$windowObject;
if (typeof window !== "undefined") $33065e702bd15fb9$var$windowObject = window;
else if (typeof self !== "undefined") // eslint-disable-next-line no-restricted-globals
$33065e702bd15fb9$var$windowObject = self;
else $33065e702bd15fb9$var$windowObject = $parcel$global;
let $33065e702bd15fb9$var$cancelFrame = null;
let $33065e702bd15fb9$var$requestFrame = null;
const $33065e702bd15fb9$var$TIMEOUT_DURATION = 20;
const $33065e702bd15fb9$var$clearTimeoutFn = $33065e702bd15fb9$var$windowObject.clearTimeout;
const $33065e702bd15fb9$var$setTimeoutFn = $33065e702bd15fb9$var$windowObject.setTimeout;
const $33065e702bd15fb9$var$cancelAnimationFrameFn = $33065e702bd15fb9$var$windowObject.cancelAnimationFrame || $33065e702bd15fb9$var$windowObject.mozCancelAnimationFrame || $33065e702bd15fb9$var$windowObject.webkitCancelAnimationFrame;
const $33065e702bd15fb9$var$requestAnimationFrameFn = $33065e702bd15fb9$var$windowObject.requestAnimationFrame || $33065e702bd15fb9$var$windowObject.mozRequestAnimationFrame || $33065e702bd15fb9$var$windowObject.webkitRequestAnimationFrame;
if ($33065e702bd15fb9$var$cancelAnimationFrameFn == null || $33065e702bd15fb9$var$requestAnimationFrameFn == null) {
    // For environments that don't support animation frame,
    // fallback to a setTimeout based approach.
    $33065e702bd15fb9$var$cancelFrame = $33065e702bd15fb9$var$clearTimeoutFn;
    $33065e702bd15fb9$var$requestFrame = function requestAnimationFrameViaSetTimeout(callback) {
        return $33065e702bd15fb9$var$setTimeoutFn(callback, $33065e702bd15fb9$var$TIMEOUT_DURATION);
    };
} else {
    // Counter intuitively, environments that support animation frames can be trickier.
    // Chrome's "Throttle non-visible cross-origin iframes" flag can prevent rAFs from being called.
    // In this case, we should fallback to a setTimeout() implementation.
    $33065e702bd15fb9$var$cancelFrame = function cancelFrame([animationFrameID, timeoutID]) {
        $33065e702bd15fb9$var$cancelAnimationFrameFn(animationFrameID);
        $33065e702bd15fb9$var$clearTimeoutFn(timeoutID);
    };
    $33065e702bd15fb9$var$requestFrame = function requestAnimationFrameWithSetTimeoutFallback(callback) {
        const animationFrameID = $33065e702bd15fb9$var$requestAnimationFrameFn(function animationFrameCallback() {
            $33065e702bd15fb9$var$clearTimeoutFn(timeoutID);
            callback();
        });
        const timeoutID = $33065e702bd15fb9$var$setTimeoutFn(function timeoutCallback() {
            $33065e702bd15fb9$var$cancelAnimationFrameFn(animationFrameID);
            callback();
        }, $33065e702bd15fb9$var$TIMEOUT_DURATION);
        return [
            animationFrameID,
            timeoutID
        ];
...
function $33065e702bd15fb9$var$createDetectElementResize(nonce) {
    ...
    if (!attachEvent) {
        ...
        scrollListener = function(e) {
            ...
            const element = this;
            resetTriggers(this);
            if (this.__resizeRAF__) $33065e702bd15fb9$var$cancelFrame(this.__resizeRAF__);
            this.__resizeRAF__ = $33065e702bd15fb9$var$requestFrame(function animationFrame() {
    ...
    const addResizeListener = function(element, fn) {
        if (attachEvent) element.attachEvent("onresize", fn);
            ...
            if (!element.__resizeTriggers__) {
                ...
                const elementStyle = $33065e702bd15fb9$var$windowObject.getComputedStyle(element);
...
$33065e702bd15fb9$exports = {
    createDetectElementResize: $33065e702bd15fb9$var$createDetectElementResize
};
...
class $4fd1a97a17b80f9f$export$9d94f4ee1d930ff extends (0, $8zHUo$react.Component) {
    constructor(...args){
        ...
        $4fd1a97a17b80f9f$var$_defineProperty(this, "_resizeObserver", null);
        ...
        if (this._autoSizer && this._autoSizer.parentNode && this._autoSizer.parentNode.ownerDocument && this._autoSizer.parentNode.ownerDocument.defaultView && this._autoSizer.parentNode instanceof this._autoSizer.parentNode.ownerDocument.defaultView.HTMLElement) {
            ...
            if (this._parentNode != null) {
                if (typeof ResizeObserver !== "undefined") {
                    ...
                    this._detectElementResize = (0, $33065e702bd15fb9$exports.createDetectElementResize)(nonce);
