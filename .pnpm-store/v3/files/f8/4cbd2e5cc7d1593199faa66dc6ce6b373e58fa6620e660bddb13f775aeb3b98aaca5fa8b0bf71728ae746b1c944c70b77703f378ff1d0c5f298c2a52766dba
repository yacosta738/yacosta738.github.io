...
var q = (e) => F(k({}, "__esModule", { value: !0 }), e);
...
}, V = (e) => (g(e, y, { value: { reset: () => D(e[y]) } }), e[y]), I = (e) => e[y] || V(e);
function m(e) {
...
function A(e) {
  ...
  }), ["called", "callCount", "results", "calls", "reset", "impl"].forEach((r) => g(e, r, { get: () => t[r], set: (o) => t[r] = o })), l(e, "nextError", (r) => (t.next = ["error", r], t)), l(e, "nextResult", (r) => (t.next = ["ok", r], t));
}
...
function K(e, t, r) {
  ...
  R(s || n in e, `${String(n)} does not exist`);
  let v = !1;
  ...
  let x = m(r), O = (w) => {
    ...
    a !== "value" && delete h.writable, h[a] = w, g(e, n, h);
  }, M = () => O(c), T = x[y];
  return l(T, "restore", M), l(T, "getOriginal", () => v ? c() : c), l(T, "willCall", (w) => (T.impl = w, x)), O(v ? () => x : x), f.add(x), x;
}
function $(e, t, r) {
  let o = K(e, t, r);
