...
import { Fn, MaybeRef, MaybeRefOrGetter, Awaitable, ConfigurableEventFilter, ConfigurableFlush, RemovableRef, EventHookOn, Arrayable, ReadonlyRefOrGetter, Pausable, UseIntervalFnOptions, UseTimeoutFnOptions } from '@vueuse/shared';
export * from '@vueuse/shared';
import * as vue_demi from 'vue-demi';
import { Ref, InjectionKey, ComputedRef, Slot, DefineComponent, TransitionGroupProps, ComponentPublicInstance, Component, ShallowRef, WritableComputedRef, UnwrapRef, WatchOptions, UnwrapNestedRefs, WatchSource, ToRefs, StyleValue } from 'vue-demi';
...
type DefineTemplateComponent<Bindings extends object, Slots extends Record<string, Slot | undefined>> = DefineComponent<{}> & {
    new (): {
        $slots: {
            default(_: Bindings & {
                $slots: Slots;
...
type ReuseTemplateComponent<Bindings extends object, Slots extends Record<string, Slot | undefined>> = DefineComponent<Bindings> & {
    new (): {
        $slots: Slots;
    };
};
type ReusableTemplatePair<Bindings extends object, Slots extends Record<string, Slot | undefined>> = [
 ...
 */
declare function createReusableTemplate<Bindings extends object, Slots extends Record<string, Slot | undefined> = Record<string, Slot | undefined>>(): ReusableTemplatePair<Bindings, Slots>;
 ...
 * @param options
 */
declare function useBreakpoints<K extends string>(breakpoints: Breakpoints<K>, options?: ConfigurableWindow): Record<K, Ref<boolean>> & {
...
type UseColorModeReturn<T extends string = BasicColorSchema> = Ref<T> & {
    store: Ref<T>;
 ...
 * @param options
 */
declare function useColorMode<T extends string = BasicColorSchema>(options?: UseColorModeOptions<T>): UseColorModeReturn<T>;
...
declare function useDropZone(target: MaybeRefOrGetter<HTMLElement | null | undefined>, onDrop?: (files: File[] | null) => void): UseDropZoneReturn;
 ...
 */
declare function useWebNotification(defaultOptions?: UseWebNotificationOptions): {
    isSupported: vue_demi.ComputedRef<boolean>;
