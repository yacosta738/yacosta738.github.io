  ...
  createClass(AnnotationCommands, [{
    ...
    value: function setAnnotation(key, props) {
      ...
      for (var k in props) {
        ...
        if (isPoint && !exports.Point.equals(props[k], annotation[k]) || !isPoint && props[k] !== annotation[k]) {
          newProps[k] = props[k];
  ...
  createClass(DeletingCommands, [{
    ...
    value: function _delete() {
      ...
      this.withoutNormalizing(function () {
        ...
        if (exports.Range.isRange(at) && exports.Range.isCollapsed(at)) {
          at = at.anchor;
        }

        if (exports.Point.isPoint(at)) {
        ...
        if (exports.Range.isCollapsed(at)) {
          return;
        }
        ...
        var _Range$edges = exports.Range.edges(at),
        ...
        var isSingleText = exports.Path.equals(start.path, end.path);
        ...
        if (startVoid) {
          ...
          if (before && block && exports.Path.isAncestor(block[1], before.path)) {
            start = before;
          }
        }
        ...
        if (endVoid) {
          ...
          if (after && _block && exports.Path.isAncestor(_block[1], after.path)) {
            end = after;
          }
        ...
        var matches = _this.matches({
          ...
          match: function match(_ref) {
            ...
            return exports.Element.isElement(n) && _this.isVoid(n) || !exports.Path.isCommon(p, start.path) && !exports.Path.isCommon(p, end.path);
          }
        });
        ...
        var isBlockAncestor = exports.Value.isValue(ancestor) || exports.Element.isElement(ancestor) && !_this.isInline(ancestor);
    ...
    value: function insertFragment(fragment) {
      ...
      this.withoutNormalizing(function () {
        ...
        if (exports.Range.isRange(at)) {
          var _Range$edges3 = exports.Range.edges(at),
        ...
        if (!exports.Point.isPoint(at) || _this2.getMatch(at.path, 'void')) {
          return;
        }
        ...
        if (pointRef.current) {
          ...
          if (afterClosest && beforeClosest) {
            ...
            var startPath = exports.Path.next(beforePath);
      ...
      this.withoutNormalizing(function () {
        ...
        if (exports.Range.isRange(at)) {
          if (exports.Range.isCollapsed(at)) {
            ...
            var pointRef = _this3.createPointRef(exports.Range.end(at));
        ...
        if (exports.Point.isPoint(at) && !_this3.getMatch(at.path, 'void')) {
          var _at = at,
              path = _at.path,
              offset = _at.offset;
    ...
    value: function removeText(text) {
      ...
      this.withoutNormalizing(function () {
        ...
        if (!at || exports.Range.isCollapsed(at)) {
          return;
        }

        var _Range$edges5 = exports.Range.edges(at),
        ...
        try {
          for (var _iterator = _this4.texts({
            ...
            if (exports.Point.isPoint(at) && !_this4.getMatch(at.path, 'void')) {
              var _path3 = at.path,
                  offset = at.offset;
...
function () {
  ...
  createClass(NodeCommands, [{
    ...
    value: function insertNodes(nodes) {
      ...
      this.withoutNormalizing(function () {
        ...
        if (match == null) {
          if (exports.Path.isPath(at)) {
            match = at.length;
          } else if (exports.Text.isText(node)) {
            match = 'text';
        ...
        if (exports.Point.isPoint(at)) {
          ...
          if (atMatch) {
            ...
            at = isAtEnd ? exports.Path.next(path) : path;
          } else {
            return;
          }
        }

        var parentPath = exports.Path.parent(at);
    ...
    value: function liftNodes(options) {
      ...
      this.withoutNormalizing(function () {
        var _options$at = options.at,
            ...
            match = _options$match === void 0 ? exports.Path.isPath(at) ? at.length : 'block' : _options$match;
        ...
        for (var _i = 0, _pathRefs = pathRefs; _i < _pathRefs.length; _i++) {
          ...
          var _this2$getNode = _this2.getNode(exports.Path.parent(path)),
          ...
          if (length === 1) {
            _this2.moveNodes({
              at: path,
              to: exports.Path.next(parentPath)
            });
    ...
    value: function mergeNodes() {
      ...
      this.withoutNormalizing(function () {
        ...
        var _options$match2 = options.match,
            match = _options$match2 === void 0 ? exports.Path.isPath(at) ? at.length : 'block' : _options$match2,
            _options$hanging = options.hanging,
            hanging = _options$hanging === void 0 ? false : _options$hanging;
        ...
        if (!hanging && exports.Range.isRange(at)) {
        ...
        var newPath = exports.Path.next(prevPath);
        var commonPath = exports.Path.common(path, prevPath);
        var isPreviousSibling = exports.Path.isSibling(path, prevPath); // Determine if the merge will leave an ancestor of the path empty as a
        // result, in which case we'll want to remove it after merging.

        var emptyAncestor = exports.Node.furthest(_this3.value, path, function (_ref3) {
          var _ref4 = slicedToArray(_ref3, 2),
              n = _ref4[0],
              p = _ref4[1];

          return exports.Path.isDescendant(p, commonPath) && exports.Path.isAncestor(p, path) && exports.Element.isElement(n) && n.nodes.length === 1;
        });
        ...
        if (exports.Text.isText(node) && exports.Text.isText(prevNode)) {
          var text = node.text,
              marks = node.marks,
          ...
          properties = rest;
        } else if (exports.Element.isElement(node) && exports.Element.isElement(prevNode)) {
        ...
        if (exports.Element.isElement(prevNode) && _this3.isEmpty(prevNode) || exports.Text.isText(prevNode) && prevNode.text === '') {
          _this3.removeNodes({
            at: prevPath
          });
        } else {
    ...
    value: function moveNodes(options) {
      ...
      this.withoutNormalizing(function () {
        var to = options.to,
            ...
            match = _options$match3 === void 0 ? exports.Path.isPath(at) ? at.length : 'block' : _options$match3;
    ...
    value: function normalizeNodes(options) {
      ...
      if (exports.Text.isText(node)) {
        return;
      } // Ensure that block and inline nodes have at least one text child.


      if (exports.Element.isElement(node) && node.nodes.length === 0) {
        var child = {
          text: '',
          marks: []
        };
      ...
      var shouldHaveInlines = exports.Element.isElement(node) && (this.isInline(node) || node.nodes.length === 0 || exports.Text.isText(node.nodes[0]) || this.isInline(node.nodes[0])); // Since we'll be applying operations while iterating, keep track of an
      ...
      for (var i = 0; i < node.nodes.length; i++, n++) {
        ...
        if (exports.Element.isElement(_child)) {
          ...
          if (isInline) {
            if (prev == null || !exports.Text.isText(prev)) {
              var _child2 = {
                text: '',
                marks: []
              };
          ...
          if (prev != null && exports.Text.isText(prev)) {
            if (exports.Text.matches(_child, prev)) {
              this.mergeNodes({
                at: at.concat(n)
              });
              n--;
    ...
    value: function removeNodes() {
      ...
      this.withoutNormalizing(function () {
        ...
        var _options$match4 = options.match,
            match = _options$match4 === void 0 ? exports.Path.isPath(at) ? at.length : 'block' : _options$match4,
    ...
    value: function setNodes(props) {
      ...
      this.withoutNormalizing(function () {
        ...
        var _options$match5 = options.match,
            match = _options$match5 === void 0 ? exports.Path.isPath(at) ? at.length : 'block' : _options$match5,
    ...
    value: function splitNodes() {
      ...
      this.withoutNormalizing(function () {
        ...
        if (match == null) {
          match = exports.Path.isPath(at) ? at.length : 'block';
        }
        ...
        if (voidMatch) {
          ...
          if (exports.Element.isElement(voidNode) && _this7.isInline(voidNode)) {
            ...
            if (!after) {
              ...
              var afterPath = exports.Path.next(voidPath);
        ...
        try {
          for (var _iterator3 = _this7.levels({
            ...
            if (path.length < highestPath.length || path.length === 0 || exports.Element.isElement(node) && _this7.isVoid(node)) {
              break;
            }
    ...
    value: function unwrapNodes(options) {
      ...
      this.withoutNormalizing(function () {
        var _options$at7 = options.at,
            ...
            match = _options$match6 === void 0 ? exports.Path.isPath(at) ? at.length : 'block' : _options$match6,
        ...
        for (var _i4 = 0, _pathRefs4 = pathRefs; _i4 < _pathRefs4.length; _i4++) {
          ...
          if (split && exports.Range.isRange(at)) {
            range = exports.Range.intersection(at, range);
          }
      ...
      this.withoutNormalizing(function () {
        ...
        try {
          for (var _iterator4 = roots[Symbol.iterator](), _step4; !(_iteratorNormalCompletion4 = (_step4 = _iterator4.next()).done); _iteratorNormalCompletion4 = true) {
            ...
            var a = exports.Range.isRange(at) ? exports.Range.intersection(at, _this9.getRange(rootPath)) : at;
            ...
            if (matches.length > 0) {
              ...
              var commonPath = exports.Path.equals(firstPath, lastPath) ? exports.Path.parent(firstPath) : exports.Path.common(firstPath, lastPath);

              var range = _this9.getRange(firstPath, lastPath);

              var depth = commonPath.length + 1;
              var wrapperPath = exports.Path.next(lastPath).slice(0, depth);
...
var deleteRange = function deleteRange(editor, range) {
  if (exports.Range.isCollapsed(range)) {
    return range.anchor;
  } else {
    var _Range$edges7 = exports.Range.edges(range),
      ...
      this.withoutNormalizing(function () {
        ...
        try {
          for (var _iterator = marks[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
            ...
            if (!exports.Mark.exists(mark, set)) {
              set.push(mark);
            }
          }
        } catch (err) {
          ...
          for (var _iterator2 = _this.texts({
            ...
            try {
              for (var _iterator3 = set[Symbol.iterator](), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
                ...
                if (!exports.Mark.exists(_mark, node.marks)) {
                  _this.apply({
                    type: 'add_mark',
                    path: path,
                    mark: _mark
        ...
        if (at) {
          ...
          try {
            for (var _iterator4 = _this2.marks({
              ...
              if (exports.Mark.exists(mark, marks)) {
                _this2.apply({
                  type: 'remove_mark',
                  path: path,
                  mark: mark
    ...
    value: function toggleMarks(marks) {
      ...
      this.withoutNormalizing(function () {
        ...
        var exists = marks.every(function (m) {
          return exports.Mark.exists(m, existing);
        });
  ...
  createClass(SelectionCommands, [{
    ...
    value: function collapse() {
      ...
      if (!selection) {
        ...
        var _Range$edges = exports.Range.edges(selection),
            _Range$edges2 = slicedToArray(_Range$edges, 1),
            start = _Range$edges2[0];

        this.select(start);
      } else if (edge === 'end') {
        var _Range$edges3 = exports.Range.edges(selection),
            _Range$edges4 = slicedToArray(_Range$edges3, 2),
            end = _Range$edges4[1];
    ...
    value: function move() {
      ...
      if (edge === 'start') {
        edge = exports.Range.isBackward(selection) ? 'focus' : 'anchor';
      }

      if (edge === 'end') {
        edge = exports.Range.isBackward(selection) ? 'anchor' : 'focus';
      }
    ...
    value: function select(target) {
      ...
      if (!exports.Range.isRange(target)) {
    ...
    value: function setSelection(props) {
      ...
      for (var k in props) {
        if (k === 'anchor' && props.anchor != null && !exports.Point.equals(props.anchor, selection.anchor) || k === 'focus' && props.focus != null && !exports.Point.equals(props.focus, selection.focus) || k !== 'anchor' && k !== 'focus' && props[k] !== selection[k]) {
...
function () {
  ...
  createClass(GeneralCommands, [{
    ...
    value: function apply(op) {
      ...
      this.value = exports.Value.transform(this.value, op);
      ...
      try {
        for (var _iterator4 = DIRTY_PATHS.get(this)[Symbol.iterator](), _step4; !(_iteratorNormalCompletion4 = (_step4 = _iterator4.next()).done); _iteratorNormalCompletion4 = true) {
          ...
          add(exports.Path.transform(path, op));
        }
      } catch (err) {
        _didIteratorError4 = true;
        _iteratorError4 = err;
    ...
    value: function normalize() {
      ...
      if (force) {
        var allPaths = Array.from(exports.Node.nodes(this.value), function (_ref3) {
          var _ref4 = slicedToArray(_ref3, 2),
              p = _ref4[1];
...
var getDirtyPaths = function getDirtyPaths(op) {
  switch (op.type) {
    ...
    case 'set_node':
      {
        var path = op.path;
        return exports.Path.levels(path);
      }
    ...
    case 'insert_node':
      {
        var node = op.node,
            _path2 = op.path;
        var levels = exports.Path.levels(_path2);
        var descendants = exports.Text.isText(node) ? [] : Array.from(exports.Node.nodes(node), function (_ref5) {
          var _ref6 = slicedToArray(_ref5, 2),
              p = _ref6[1];
    ...
    case 'merge_node':
      {
        var _path3 = op.path;
        var ancestors = exports.Path.ancestors(_path3);
        var previousPath = exports.Path.previous(_path3);
    ...
    case 'move_node':
      {
        ...
        if (exports.Path.equals(_path4, newPath)) {
          return [];
        }
        ...
        try {
          for (var _iterator6 = exports.Path.ancestors(_path4)[Symbol.iterator](), _step6; !(_iteratorNormalCompletion6 = (_step6 = _iterator6.next()).done); _iteratorNormalCompletion6 = true) {
            var ancestor = _step6.value;

            var _path5 = exports.Path.transform(ancestor, op);
        ...
        try {
          for (var _iterator7 = exports.Path.ancestors(newPath)[Symbol.iterator](), _step7; !(_iteratorNormalCompletion7 = (_step7 = _iterator7.next()).done); _iteratorNormalCompletion7 = true) {
            var _ancestor = _step7.value;

            var _path6 = exports.Path.transform(_ancestor, op);
    ...
    case 'remove_node':
      {
        ...
        var _ancestors = exports.Path.ancestors(_path7);
    ...
    case 'split_node':
      {
        ...
        var _levels = exports.Path.levels(_path8);

        var nextPath = exports.Path.next(_path8);
  ...
  createClass(ElementQueries, [{
    ...
    value: function hasBlocks(element) {
      ...
      return element.nodes.some(function (n) {
        return exports.Element.isElement(n) && !_this.isInline(n);
      });
    }
    /**
    ...
    value: function hasInlines(element) {
      ...
      return element.nodes.some(function (n) {
        return exports.Text.isText(n) || exports.Element.isElement(n) && _this2.isInline(n);
      });
    }
    /**
    ...
    value: function isEmpty(element) {
      ...
      return nodes.length === 0 || nodes.length === 1 && exports.Text.isText(first) && first.text === '' && !this.isVoid(element);
    }
    /**
...
function () {
  ...
  createClass(LocationQueries, [{
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            ...
            case 7:
              ...
              if (!(at && !exports.Range.includes(range, annotation))) {
                _context.next = 12;
                break;
              }
        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            ...
            case 4:
              ...
              return _context2.delegateYield(exports.Node.elements(this.value, _objectSpread$1({}, options, {
                from: from,
                to: to,
                pass: function pass(_ref) {
                  ...
                  return exports.Element.isElement(n) && _this.isVoid(n);
                }
              })), "t0", 6);
    ...
    value: function getActiveMarks() {
      ...
      if (exports.Range.isCollapsed(at) && at.anchor.offset === 0) {
        var _at = at,
            anchor = _at.anchor;
        var prev = this.getPrevious(anchor, 'text');

        if (prev && exports.Path.isSibling(anchor.path, prev[1])) {
          var _prev = slicedToArray(prev, 2),
              prevNode = _prev[0],
              prevPath = _prev[1];

          if (exports.Text.isText(prevNode)) {
        ...
        for (var _iterator = this.texts({
          ...
          if (union) {
            ...
            for (var i = marks.length - 1; i >= 0; i--) {
              ...
              if (!exports.Mark.exists(existing, node.marks)) {
                marks.splice(i, 1);
              }
            }
          }
    ...
    value: function getAncestor(at) {
      ...
      if (exports.Path.isPath(at) || exports.Point.isPoint(at)) {
        return this.getParent(at, options);
      }

      var path = this.getPath(at, options);
      var ancestorPath = exports.Path.equals(at.anchor.path, at.focus.path) ? exports.Path.parent(path) : path;
      var ancestor = exports.Node.get(this.value, ancestorPath);
    ...
    value: function getFragment(at) {
      ...
      var fragment = exports.Node.fragment(this.value, range);
      return fragment;
    }
    /**
    ...
    value: function getLeaf(at) {
      var options = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
      var path = this.getPath(at, options);
      var node = exports.Node.leaf(this.value, path);
      return [node, path];
    }
    /**
    ...
    value: function getNode(at) {
      var options = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
      var path = this.getPath(at, options);
      var node = exports.Node.get(this.value, path);
      return [node, path];
    }
    /**
    ...
    value: function getParent(at) {
      var options = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
      var path = this.getPath(at, options);
      var parentPath = exports.Path.parent(path);
    ...
    value: function getPath(at) {
      ...
      if (exports.Path.isPath(at)) {
        if (edge === 'start') {
          var _Node$first = exports.Node.first(this.value, at),
              _Node$first2 = slicedToArray(_Node$first, 2),
              firstPath = _Node$first2[1];

          at = firstPath;
        } else if (edge === 'end') {
          var _Node$last = exports.Node.last(this.value, at),
      ...
      if (exports.Range.isRange(at)) {
        if (edge === 'start') {
          at = exports.Range.start(at);
        } else if (edge === 'end') {
          at = exports.Range.end(at);
        } else {
          at = exports.Path.common(at.anchor.path, at.focus.path);
        }
      }
    ...
    value: function getPoint(at) {
      ...
      if (exports.Path.isPath(at)) {
        ...
        if (edge === 'end') {
          var _Node$last3 = exports.Node.last(this.value, at),
              _Node$last4 = slicedToArray(_Node$last3, 2),
              lastPath = _Node$last4[1];

          path = lastPath;
        } else {
          var _Node$first3 = exports.Node.first(this.value, at),
    ...
    value: function getRange(at, to) {
      if (exports.Range.isRange(at) && !to) {
        return at;
      }
    ...
    value: function getText(at) {
      ...
      var _Range$edges3 = exports.Range.edges(range),
          _Range$edges4 = slicedToArray(_Range$edges3, 2),
      ...
      try {
        for (var _iterator8 = this.texts({
          ...
          if (exports.Path.equals(path, end.path)) {
            t = t.slice(0, end.offset);
          }

          if (exports.Path.equals(path, start.path)) {
    ...
    value: function hasNode(at) {
      var options = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
      var path = this.getPath(at, options);
      var exists = exports.Node.has(this.value, path);
      return exists;
    }
    /**
    ...
    value: function isStart(point, at) {
      ...
      var start = this.getStart(at);
      return exports.Point.equals(point, start);
    }
    /**
    ...
    value: function isEnd(point, at) {
      ...
      return exports.Point.equals(point, end);
    }
    /**
        ...
        while (1) {
          switch (_context3.prev = _context3.next) {
            ...
            case 4:
              ...
              _context3.prev = 9;
              _iterator9 = exports.Node.levels(this.value, path)[Symbol.iterator]();
            ...
            case 11:
              ...
              if (!(exports.Element.isElement(n) && this.isVoid(n))) {
                _context3.next = 16;
                break;
              }
        ...
        while (1) {
          switch (_context4.prev = _context4.next) {
            ...
            case 4:
              ...
              return _context4.delegateYield(exports.Node.marks(this.value, _objectSpread$1({}, options, {
                from: from,
                to: to,
                pass: function pass(_ref3) {
                  ...
                  return exports.Element.isElement(n) && _this2.isVoid(n);
                }
              })), "t0", 6);
      ...
      return regenerator.wrap(function matches$(_context5) {
        while (1) {
          switch (_context5.prev = _context5.next) {
            case 0:
              _options$at6 = options.at, at = _options$at6 === void 0 ? this.value.selection : _options$at6, _options$match = options.match, match = _options$match === void 0 ? exports.Path.isPath(at) ? at : function () {
                return true;
            ...
            case 8:
              ...
              if (!(prevPath && exports.Path.compare(p, prevPath) === 0)) {
                _context5.next = 12;
                break;
              }
        ...
        while (1) {
          switch (_context6.prev = _context6.next) {
            ...
            case 4:
              ...
              iterable = exports.Node.nodes(this.value, _objectSpread$1({}, options, {
                from: from,
                to: to,
                pass: function pass(_ref5) {
                  ...
                  return exports.Element.isElement(n) && _this3.isVoid(n);
                }
              }));
        ...
        while (1) {
          switch (_context7.prev = _context7.next) {
            case 0:
              ...
              _options$at8 = options.at, at = _options$at8 === void 0 ? this.value.selection : _options$at8, _options$unit = options.unit, unit = _options$unit === void 0 ? 'offset' : _options$unit, _options$reverse3 = options.reverse, reverse = _options$reverse3 === void 0 ? false : _options$reverse3;
            ...
            case 4:
              range = this.getRange(at);
              _Range$edges5 = exports.Range.edges(range), _Range$edges6 = slicedToArray(_Range$edges5, 2), start = _Range$edges6[0], end = _Range$edges6[1];
            ...
            case 18:
              ...
              if (!exports.Element.isElement(node)) {
                _context7.next = 28;
                break;
              }
            ...
            case 27:
              if (this.hasInlines(node)) {
                e = exports.Path.isAncestor(path, end.path) ? end : this.getEnd(path);
                s = exports.Path.isAncestor(path, start.path) ? start : this.getStart(path);
                text = this.getText({
                  anchor: s,
                  focus: e
                });
            ...
            case 28:
              ...
              isFirst = exports.Path.equals(path, first.path);
        ...
        while (1) {
          switch (_context8.prev = _context8.next) {
            ...
            case 4:
              ...
              return _context8.delegateYield(exports.Node.texts(this.value, _objectSpread$1({}, options, {
                from: from,
                to: to,
                pass: function pass(_ref7) {
                  ...
                  return exports.Element.isElement(n) && _this4.isVoid(n);
                }
              })), "t0", 6);
...
var isMatch = function isMatch(editor, entry, match) {
  ...
  if (typeof match === 'function') {
    ...
    return exports.Text.isText(node);
  } else if (match === 'value') {
    return exports.Value.isValue(node);
  } else if (match === 'inline') {
    return exports.Element.isElement(node) && editor.isInline(node) || exports.Text.isText(node);
  } else if (match === 'block') {
    return exports.Element.isElement(node) && !editor.isInline(node) && editor.hasInlines(node);
  } else if (match === 'void') {
    return exports.Element.isElement(node) && editor.isVoid(node);
  } else if (exports.Path.isPath(match)) {
    return exports.Path.equals(path, match);
  } else {
    return exports.Node.matches(node, match);
  }
};
...
function () {
  ...
  createClass(RangeQueries, [{
    ...
    value: function unhangRange(range) {
      var _Range$edges = exports.Range.edges(range),
          _Range$edges2 = slicedToArray(_Range$edges, 2),
          start = _Range$edges2[0],
          end = _Range$edges2[1]; // PERF: exit early if we can guarantee that the range isn't hanging.


      if (start.offset !== 0 || end.offset !== 0 || exports.Range.isCollapsed(range)) {
        return range;
      }
      ...
      try {
        for (var _iterator = this.texts({
          ...
          if (node.text !== '' || exports.Path.isBefore(path, blockPath)) {
            end = {
              path: path,
...
var Editor = function Editor() {
  ...
  var _props$onChange = props.onChange,
      ...
      value = _props$value === void 0 ? immer.produce({
    nodes: [],
    selection: null,
    annotations: {}
...
function () {
  ...
  createClass(PathRef, [{
    ...
    value: function transform(op) {
      ...
      var path = exports.Path.transform(current, op, {
        affinity: affinity
      });
      this.current = path;
...
function () {
  ...
  createClass(PointRef, [{
    ...
    value: function transform(op) {
      ...
      var point = exports.Point.transform(current, op, {
        affinity: affinity
      });
      this.current = point;
...
function () {
  ...
  createClass(RangeRef, [{
    ...
    value: function transform(op) {
      ...
      var range = exports.Range.transform(current, op, {
        affinity: affinity
      });
      this.current = range;
...
(function (Element) {
  ...
  Element.isElement = function (value) {
    return isPlainObject(value) && exports.Node.isNodeList(value.nodes) && !exports.Value.isValue(value);
  };
  /**
...
(function (Fragment) {
  ...
  Fragment.isFragment = function (value) {
    return isPlainObject(value) && exports.Node.isNodeList(value.nodes);
  };
})(exports.Fragment || (exports.Fragment = {}));
...
(function (Location) {
  ...
  Location.isLocation = function (value) {
    return exports.Path.isPath(value) || exports.Point.isPoint(value) || exports.Range.isRange(value);
  };
...
(function (Span) {
  ...
  Span.isSpan = function (value) {
    return Array.isArray(value) && value.length === 2 && value.every(exports.Path.isPath);
  };
})(exports.Span || (exports.Span = {}));
...
(function (Node) {
  ...
  Node.matches = function (node, props) {
    return exports.Value.isValue(node) && exports.Value.matches(node, props) || exports.Element.isElement(node) && exports.Element.matches(node, props) || exports.Text.isText(node) && exports.Text.matches(node, props);
  };
  /**
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            _context.prev = 4;
            _iterator = exports.Path.ancestors(path, options)[Symbol.iterator]();
  ...
  Node.common = function (root, path, another) {
    var p = exports.Path.common(path, another);
  ...
  Node.first = function (root, path) {
    ...
    while (n) {
      if (exports.Text.isText(n) || n.nodes.length === 0) {
        break;
      } else {
        n = n.nodes[0];
        p.push(0);
  ...
  Node.fragment = function (root, range) {
    ...
    return immer.produce(root, function (r) {
      var _Range$edges = exports.Range.edges(range),
          _Range$edges2 = slicedToArray(_Range$edges, 2),
          start = _Range$edges2[0],
          end = _Range$edges2[1];
      ...
      var iterable = Node.nodes(r, {
        ...
        pass: function pass(_ref) {
          ...
          return !exports.Range.includes(range, path);
        }
      });
      var _iteratorNormalCompletion5 = true;
      var _didIteratorError5 = false;
      ...
      try {
        for (var _iterator5 = iterable[Symbol.iterator](), _step5; !(_iteratorNormalCompletion5 = (_step5 = _iterator5.next()).done); _iteratorNormalCompletion5 = true) {
          ...
          if (!exports.Range.includes(range, path)) {
  ...
  Node.get = function (root, path) {
    ...
    for (var i = 0; i < path.length; i++) {
      ...
      if (exports.Text.isText(node) || !node.nodes[p]) {
  ...
  Node.isNode = function (value) {
    return exports.Text.isText(value) || exports.Element.isElement(value) || exports.Value.isValue(value);
  };
  /**
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          case 0:
            ...
            _context4.prev = 4;
            _iterator7 = exports.Path.levels(path, options)[Symbol.iterator]();
      ...
      while (1) {
        switch (_context6.prev = _context6.next) {
          ...
          case 6:
            ...
            if (!(to && (reverse ? exports.Path.isBefore(p, to) : exports.Path.isAfter(p, to)))) {
              _context6.next = 9;
              break;
            }
          ...
          case 12:
            if (!(!visited.has(n) && !exports.Text.isText(n) && n.nodes.length !== 0 && (pass == null || pass([n, p]) === false))) {
              _context6.next = 19;
              break;
            }
            ...
            if (exports.Path.isAncestor(p, from)) {
          ...
          case 27:
            ...
            _newPath = exports.Path.previous(p);
            p = _newPath;
            n = Node.get(root, p);
            return _context6.abrupt("continue", 6);
...
(function (Operation) {
  ...
  Operation.isOperation = function (value) {
    ...
    switch (value.type) {
      case 'add_mark':
        {
          return exports.Path.isPath(value.path) && exports.Mark.isMark(value.mark);
        }

      case 'add_annotation':
        {
          return typeof value.key === 'string' && exports.Range.isRange(value.annotation);
        }

      case 'insert_node':
        {
          return exports.Path.isPath(value.path) && exports.Node.isNode(value.node);
        }

      case 'insert_text':
        {
          return typeof value.offset === 'number' && typeof value.text === 'string' && exports.Path.isPath(value.path);
        }

      case 'merge_node':
        {
          return typeof value.position === 'number' && (typeof value.target === 'number' || value.target === null) && exports.Path.isPath(value.path) && isPlainObject(value.properties);
        }

      case 'move_node':
        {
          return exports.Path.isPath(value.path) && exports.Path.isPath(value.newPath);
        }
      ...
      case 'set_mark':
        {
          return exports.Path.isPath(value.path) && isPlainObject(value.properties) && isPlainObject(value.newProperties);
        }
      ...
      case 'split_node':
        {
          return exports.Path.isPath(value.path) && typeof value.position === 'number' && (typeof value.target === 'number' || value.target === null) && isPlainObject(value.properties);
        }
      ...
      case 'merge_node':
        {
          return _objectSpread$2({}, op, {
            type: 'split_node',
            path: exports.Path.previous(op.path)
          });
        }
      ...
      case 'move_node':
        {
          ...
          if (exports.Path.equals(newPath, path)) {
            return op;
          ...
          var inversePath = exports.Path.transform(path, op);
          var inverseNewPath = exports.Path.transform(exports.Path.next(path), op);
          return _objectSpread$2({}, op, {
            path: inversePath,
      ...
      case 'split_node':
        {
          return _objectSpread$2({}, op, {
            type: 'merge_node',
            path: exports.Path.next(op.path)
          });
        }
    }
  };
...
(function (Point) {
  ...
  Point.compare = function (point, another) {
    var result = exports.Path.compare(point.path, another.path);
  ...
  Point.equals = function (point, another) {
    ...
    return point.offset === another.offset && exports.Path.equals(point.path, another.path);
  };
  /**
  ...
  Point.isPoint = function (value) {
    return isPlainObject(value) && typeof value.offset === 'number' && exports.Path.isPath(value.path);
  };
  /**
  ...
  Point.transform = function (point, op) {
    ...
    return immer.produce(point, function (p) {
      ...
      switch (op.type) {
        ...
        case 'move_node':
          {
            p.path = exports.Path.transform(path, op, options);
            break;
          }

        case 'insert_text':
          {
            if (exports.Path.equals(op.path, path) && op.offset <= offset) {
        ...
        case 'merge_node':
          {
            if (exports.Path.equals(op.path, path)) {
        ...
        case 'remove_node':
          {
            if (exports.Path.equals(op.path, path) || exports.Path.isAncestor(op.path, path)) {
              return null;
            }
        ...
        case 'split_node':
          {
            if (exports.Path.equals(op.path, path)) {
              if (op.position === offset && affinity == null) {
                ...
                p.offset -= op.position;
                p.path = exports.Path.transform(path, op, _objectSpread$3({}, options, {
                  affinity: 'forward'
                }));
              }
            } else {
...
(function (Range) {
  ...
  Range.intersection = function (range, another) {
    ...
    var start = exports.Point.isBefore(s1, s2) ? s2 : s1;
    var end = exports.Point.isBefore(e1, e2) ? e1 : e2;

    if (exports.Point.isBefore(end, start)) {
      return null;
    } else {
  ...
  Range.equals = function (range, another) {
    return exports.Point.equals(range.anchor, another.anchor) && exports.Point.equals(range.focus, another.focus);
  };
  /**
  ...
  Range.includes = function (range, target) {
    if (Range.isRange(target)) {
      ...
      return exports.Point.isBefore(rs, ts) && exports.Point.isAfter(re, te);
    }
    ...
    if (exports.Point.isPoint(target)) {
      isAfterStart = exports.Point.compare(target, start) >= 0;
      isBeforeEnd = exports.Point.compare(target, end) <= 0;
    } else {
      isAfterStart = exports.Path.compare(target, start.path) >= 0;
      isBeforeEnd = exports.Path.compare(target, end.path) <= 0;
    }
  ...
  Range.isBackward = function (range) {
    var anchor = range.anchor,
        focus = range.focus;
    return exports.Point.isAfter(anchor, focus);
  };
  /**
  ...
  Range.isCollapsed = function (range) {
    var anchor = range.anchor,
        focus = range.focus;
    return exports.Point.equals(anchor, focus);
  };
  /**
  ...
  Range.isRange = function (value) {
    return isPlainObject(value) && exports.Point.isPoint(value.anchor) && exports.Point.isPoint(value.focus);
  };
  /**
  ...
  Range.transform = function (range, op, options) {
    ...
    return immer.produce(range, function (r) {
      var anchor = exports.Point.transform(r.anchor, op, {
        affinity: affinityAnchor
      });
      var focus = exports.Point.transform(r.focus, op, {
      ...
      if (key === 'marks' && props.marks != null) {
        ...
        try {
          for (var _iterator = existing[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
            ...
            if (!exports.Mark.exists(m, marks)) {
              return false;
            }
          }
        } catch (err) {
        ...
        try {
          for (var _iterator2 = marks[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
            ...
            if (!exports.Mark.exists(_m, existing)) {
              return false;
            }
          }
        } catch (err) {
...
(function (Value) {
  ...
  Value.isValue = function (value) {
    return isPlainObject(value) && (value.selection === null || exports.Range.isRange(value.selection)) && exports.Node.isNodeList(value.nodes) && exports.Range.isRangeMap(value.annotations);
  };
  /**
  ...
  Value.transform = function (value, op) {
    return immer.produce(value, function (v) {
      switch (op.type) {
        case 'add_annotation':
          {
        ...
        case 'add_mark':
          {
            var path = op.path,
                mark = op.mark;
            var node = exports.Node.leaf(v, path);

            if (!exports.Mark.exists(mark, node.marks)) {
        ...
        case 'insert_node':
          {
            var _path = op.path,
                _node = op.node;
            var parent = exports.Node.parent(v, _path);
            ...
            try {
              for (var _iterator = Value.points(v)[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
                ...
                range[_key] = exports.Point.transform(point, op);
              }
            } catch (err) {
              _didIteratorError = true;
              _iteratorError = err;
        ...
        case 'insert_text':
          {
            ...
            var _node2 = exports.Node.leaf(v, _path2);
            ...
            try {
              for (var _iterator2 = Value.points(v)[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
                ...
                _range[_key2] = exports.Point.transform(_point, op);
              }
            } catch (err) {
              _didIteratorError2 = true;
              _iteratorError2 = err;
        ...
        case 'merge_node':
          {
            ...
            var _node3 = exports.Node.get(v, _path3);

            var prevPath = exports.Path.previous(_path3);
            var prev = exports.Node.get(v, prevPath);

            var _parent = exports.Node.parent(v, _path3);

            var _index = _path3[_path3.length - 1];

            if (exports.Text.isText(_node3) && exports.Text.isText(prev)) {
              prev.text += _node3.text;
            } else if (!exports.Text.isText(_node3) && !exports.Text.isText(prev)) {
              var _prev$nodes;
            ...
            try {
              for (var _iterator3 = Value.points(v)[Symbol.iterator](), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
                ...
                _range2[_key3] = exports.Point.transform(_point2, op);
              }
            } catch (err) {
              _didIteratorError3 = true;
              _iteratorError3 = err;
        ...
        case 'move_node':
          {
            ...
            if (exports.Path.isAncestor(_path4, newPath)) {
              throw new Error("Cannot move a path [".concat(_path4, "] to new path [").concat(newPath, "] because the destination is inside itself."));
            }

            var _node4 = exports.Node.get(v, _path4);

            var _parent2 = exports.Node.parent(v, _path4);
            ...
            var truePath = exports.Path.transform(_path4, op);
            var newParent = exports.Node.get(v, exports.Path.parent(truePath));
            ...
            try {
              for (var _iterator4 = Value.points(v)[Symbol.iterator](), _step4; !(_iteratorNormalCompletion4 = (_step4 = _iterator4.next()).done); _iteratorNormalCompletion4 = true) {
                ...
                _range3[_key4] = exports.Point.transform(_point3, op);
              }
            } catch (err) {
              _didIteratorError4 = true;
              _iteratorError4 = err;
        ...
        case 'remove_mark':
          {
            ...
            var _node5 = exports.Node.leaf(v, _path5);

            for (var i = 0; i < _node5.marks.length; i++) {
              if (exports.Mark.matches(_node5.marks[i], _mark)) {
        ...
        case 'remove_node':
          {
            ...
            var _parent3 = exports.Node.parent(v, _path6);

            var _Node$texts = exports.Node.texts(v, {
              from: _path6,
              reverse: true
            }),
            ...
            var _Node$texts3 = exports.Node.texts(v, {
              from: _path6
            }),
            ...
            try {
              for (var _iterator5 = Value.points(v)[Symbol.iterator](), _step5; !(_iteratorNormalCompletion5 = (_step5 = _iterator5.next()).done); _iteratorNormalCompletion5 = true) {
                ...
                var result = exports.Point.transform(_point4, op);
                ...
                if (result != null) {
                  ...
                  var newNextPath = exports.Path.transform(nextPath, op);
        ...
        case 'remove_text':
          {
            ...
            var _node6 = exports.Node.leaf(v, _path7);
            ...
            try {
              for (var _iterator6 = Value.points(v)[Symbol.iterator](), _step6; !(_iteratorNormalCompletion6 = (_step6 = _iterator6.next()).done); _iteratorNormalCompletion6 = true) {
                ...
                _range5[_key7] = exports.Point.transform(_point5, op);
              }
            } catch (err) {
              _didIteratorError6 = true;
              _iteratorError6 = err;
        ...
        case 'set_mark':
          {
            ...
            var _node7 = exports.Node.leaf(v, _path8);
            ...
            try {
              for (var _iterator7 = _node7.marks[Symbol.iterator](), _step7; !(_iteratorNormalCompletion7 = (_step7 = _iterator7.next()).done); _iteratorNormalCompletion7 = true) {
                ...
                if (exports.Mark.matches(_mark2, properties)) {
        ...
        case 'set_node':
          {
            ...
            var _node8 = exports.Node.get(v, _path9);
        ...
        case 'set_selection':
          {
            ...
            if (_newProperties3 == null) {
              ...
              if (!exports.Range.isRange(_newProperties3)) {
        ...
        case 'split_node':
          {
            ...
            var _node9 = exports.Node.get(v, _path10);

            var _parent4 = exports.Node.parent(v, _path10);

            var _index4 = _path10[_path10.length - 1];
            var newNode;

            if (exports.Text.isText(_node9)) {
            ...
            try {
              for (var _iterator8 = Value.points(v)[Symbol.iterator](), _step8; !(_iteratorNormalCompletion8 = (_step8 = _iterator8.next()).done); _iteratorNormalCompletion8 = true) {
                ...
                _range6[_key9] = exports.Point.transform(_point6, op);
              }
            } catch (err) {
              _didIteratorError8 = true;
              _iteratorError8 = err;
